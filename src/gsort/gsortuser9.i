...
# 12 "gsortuser9.F" 2 
	...
	structure /U9_TYPE/
	    ...
	    integer from, to
	    character*32 File
	    integer    dat(0:512,0:512)
	    integer    counter(0:512)
	    integer    hit(0:512)	    
	end structure
	...
	if ( flag .eq. 0 ) then
	  ...
	  if( u9.to .gt. 512 )call gs_syntax('Max. multiplicity currently limited to no more than 512')
	...
	elseif( flag .eq. 4 )then
	   ...
	   do ii = u9.from, u9.to
	      ...
	      write(nn,*)( jj,u9.dat(ii,jj), jj=0,512 )
	   enddo
	   close(unit=nn)
